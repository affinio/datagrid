...
- Clipboard copy for server-backed selections should block if the selected range includes unloaded rows, rather than serializing placeholder blanks or silently truncating missing rows.
