...
- **DoD:** выполнено для sorted-unrelated на 100k с 1/100/1000 changed rows, correctness tests и `bench:datagrid:sorted-unrelated-patch`; sorted-key, filtered-hidden, grouping/aggregation, pagination и 300k остаются отдельными validation cases.
