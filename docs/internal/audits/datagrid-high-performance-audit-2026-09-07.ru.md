...
- **Остаётся:** browser slow worker + rapid scroll/patch burst и production workload measurement с реальным columnar consumer остаются отдельной validation matrix.
