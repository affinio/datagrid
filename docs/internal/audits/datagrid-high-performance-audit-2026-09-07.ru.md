...
- **Проверки:** queue contract — 2 tests passed; renderer defer contract — 1 test passed; enqueue+flush 512 prioritized cells — 8,047.56 ops/s. Browser differential acceptance и measured final-content latency остаются открытыми.
