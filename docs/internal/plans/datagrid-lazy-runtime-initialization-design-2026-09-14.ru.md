...
2. Выполнено для column histogram и pivot projection: обе capability создаются через internal lazy slots при первом вызове, parity покрыта focused tests; formula/tree/aggregation остаются следующими кандидатами после runtime measurements.
