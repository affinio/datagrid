...
- Left/right pinned-pane and header-shell touch pan are covered by Playwright and route into the body viewport, including horizontal header pan, matching the touchpad behavior users expect on linked zones.
