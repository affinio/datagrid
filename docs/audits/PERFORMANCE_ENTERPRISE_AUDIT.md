...
3. **Sort/edit/context-menu frame cleanup**
   ...
   - Frozen inline-edit patches now reuse the existing body-row partition and lazily refresh cached body rows instead of scanning the whole row model on each commit.
