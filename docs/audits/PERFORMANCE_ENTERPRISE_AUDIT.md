...
3. **Sort/edit/context-menu frame cleanup**
   ...
   - Inline-edit burst diagnostics now have hard-failable budgets for update p95, open-to-paint p95, commit-to-paint p95, and edit-burst long-task total.
   - Current interaction-frame artifact shows context-menu is not the active blocker; remaining deep cleanup should target synchronous local sort projection and inline-edit commit bursts.
