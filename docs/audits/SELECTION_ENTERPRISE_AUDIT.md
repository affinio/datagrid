...
| --- | --- | --- |
| Active cell ownership | Documented across snapshot, anchor, focus runtime, and editing with focused contracts | Add browser-level server datasource placeholder tests |
...
| Virtualization remount continuity | Logical model is suitable; vertical, right-pinned vertical, horizontal selected-cell remounts, inline editor scroll/commit behavior, and shell placeholder materialization are browser-covered; horizontal selected-column remount, editor draft remount, and placeholder materialization selection handoff are component-covered | Needs browser tests for server datasource placeholders after remount |
...
- Active/focus/edit ownership is specified as one state machine, but browser-level server datasource placeholder proof is still incomplete.
...
- Browser/e2e coverage now proves vertical selection remount focus continuity, right-pinned vertical remount continuity, horizontal selected-cell remount continuity, inline editor scroll/commit behavior, shell placeholder materialization handoff, and grouped/tree selection workflows, while component coverage proves horizontal selected-column remount affordances, inline editor draft remount, and placeholder materialization selection handoff. Browser-level server datasource placeholders remain open.
...
2. Add e2e tests for server datasource placeholders.
