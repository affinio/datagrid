...
export default defineComponent({
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    expose({
      ...
      getSavedView: () => (dataGridRef.value as { getSavedView?: () => unknown } | null)?.getSavedView?.() ?? null,
      migrateSavedView: (...args: unknown[]) => (dataGridRef.value as { migrateSavedView?: (...values: unknown[]) => unknown } | null)?.migrateSavedView?.(...args) ?? null,
      applySavedView: (...args: unknown[]) => (dataGridRef.value as { applySavedView?: (...values: unknown[]) => unknown } | null)?.applySavedView?.(...args) ?? null,
