...
export {
  ...
  type DataGridDataSourceCellRange,
  type DataGridDataSourceClipboardFormat,
  type DataGridDataSourceOperationKind,
  type DataGridDataSourceOperationRejection,
  type DataGridDataSourceOperationRequest,
  type DataGridDataSourceOperationResult,
  type DataGridDataSourceOperationStatus,
