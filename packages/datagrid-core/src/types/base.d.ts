...
export type { DataGridColumn, DataGridColumnAlignment, DataGridColumnEditor, DataGridColumnPin, DataGridColumnGroupDef, } from "./column";
export type { DataGridSettingsAdapter } from "../dataGridSettingsAdapter";
export type DataGridRowId = string | number;
export type DataGridLazyLoadReason = "mount" | "scroll" | "manual" | "filter-change" | "sort-change" | "refresh";
...
export type DataGridLazyLoader = (context: DataGridLazyLoadContext) => Promise<void | DataGridServerLoadResult | any[]> | void | DataGridServerLoadResult | any[];
...
export type DataGridFilterOptionLoader = (context: DataGridServerFilterOptionRequest) => Promise<DataGridServerFilterOption[]> | DataGridServerFilterOption[];
...
export type DataGridSelectionMetricsProp<T = any> = boolean | DataGridSelectionMetricDefinition<T>[] | {
    enabled?: boolean;
...
export interface DataGridEventHandlers<T = any> {
    ...
    groupExpansionChange?: (groupExpansion: {
        expandedByDefault: boolean;
        toggledGroupKeys: readonly string[];
    }, groupBy: {
        fields: string[];
    ...
    lazyLoadError?: (context: DataGridLazyLoadContext & {
        error: unknown;
    }) => void;
