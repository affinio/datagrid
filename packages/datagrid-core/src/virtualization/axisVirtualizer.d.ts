...
export interface AxisVirtualizerStrategy<TMeta, TPayload> {
    ...
    computeRange(offset: number, context: AxisVirtualizerInternalContext<TMeta>, target: AxisVirtualizerRange<TPayload>): AxisVirtualizerRange<TPayload>;
...
export declare function createAxisVirtualizer<TMeta, TPayload>(axis: AxisOrientation, strategy: AxisVirtualizerStrategy<TMeta, TPayload>, initialPayload: TPayload): AxisVirtualizer<TMeta, TPayload>;
//# sourceMappingURL=axisVirtualizer.d.ts.map