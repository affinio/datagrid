import {
  ...
  calculateVisibleColumnsFromMetrics,
...
export function resolveHorizontalEffectiveViewport(
...
function resolveOverscanTailWidth(metrics: ColumnWidthMetrics, overscanColumns: number): number {
...
export function computeHorizontalScrollClamp(input: ComputeHorizontalScrollClampInput): number {
...
export function computeHorizontalVirtualWindowRange(
  input: ComputeHorizontalVirtualWindowRangeInput,
): HorizontalVirtualWindowRangeResult {
  ...
  if (!virtualizationEnabled) {
    ...
    return {
      ...
      payload: {
        ...
        effectiveViewport: resolveHorizontalEffectiveViewport(
          containerWidthForColumns,
          pinnedLeftWidth,
          pinnedRightWidth,
        ),
