import {} from "./columnSizing";
import { clamp } from "../utils/constants";
import { createAxisVirtualizer } from "./axisVirtualizer";
import { computeHorizontalScrollClamp, computeHorizontalVirtualWindowRange, resolveHorizontalEffectiveViewport, } from "./horizontalVirtualWindowMath";
export function createHorizontalAxisStrategy() {
    ...
    return {
        ...
        clampScroll(value, context) {
            ...
            if (lastClampOverscanLeading !== context.overscanLeading ||
        ...
        computeRange(offset, context, target) {
            ...
            if (lastRangeOverscanLeading !== context.overscanLeading ||
