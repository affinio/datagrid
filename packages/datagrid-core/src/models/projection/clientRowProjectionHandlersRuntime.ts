...
import type { GroupByIncrementalAggregationState } from "../aggregation/incrementalAggregationRuntime.js"
import type {
...
export interface ClientRowProjectionHandlersRuntimeContext<T> {
  ...
  treeProjectionRuntime: ReturnType<typeof import("../tree/treeProjectionRuntime.js").createTreeProjectionRuntime<T>>
  pivotRuntime: DataGridPivotRuntime<T>
  aggregationEngine: ReturnType<typeof import("../aggregation/aggregationEngine.js").createDataGridAggregationEngine<T>>
