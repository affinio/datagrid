// Computed overlay storage for the client row model. This runtime owns snapshot
// values that sit on top of immutable/base rows before they are materialized
// into an effective row view.
import type {
  DataGridRowId,
  DataGridRowNode,
} from "../rowModel.js"
