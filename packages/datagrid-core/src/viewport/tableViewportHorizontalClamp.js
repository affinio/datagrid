...
export function clampHorizontalOffset(requestedOffset, context) {
    ...
    const nativeLimit = Math.max(0, context.nativeScrollLimit != null && Number.isFinite(context.nativeScrollLimit)
        ? context.nativeScrollLimit
        : 0);
