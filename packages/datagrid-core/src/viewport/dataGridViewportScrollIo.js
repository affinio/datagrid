...
export function createDataGridViewportScrollIo(options) {
    ...
    function applyProgrammaticScrollWrites(pending) {
        const container = state.getContainer();
        if (!container) {
            return;
        }
