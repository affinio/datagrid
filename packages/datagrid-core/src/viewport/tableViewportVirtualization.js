...
import { FRAME_BUDGET_CONSTANTS, VERTICAL_VIRTUALIZATION_CONSTANTS, } from "./tableViewportConstants";
export function createTableViewportVirtualization(options) {
    ...
    function updateVisibleRows(rows, poolSizeValue, startIndexValue) {
    ...
    function resetServerIntegration() {
        lastServerFetchIndex = null;
    }
    ...
    function applyVirtualState(result, args) {
        ...
        const { pool: poolSnapshot, visibleRows: visibleRowsSnapshot, version: poolVersion } = updateVisibleRows(rows, virtualState.poolSize, virtualState.startIndex);
