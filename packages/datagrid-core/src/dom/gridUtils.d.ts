...
export declare const resolveColumnWidth: (column: UiTableColumn, zoom?: number) => number;
export declare const accumulateColumnWidths: (columns: UiTableColumn[], zoom?: number) => ColumnWidthMetrics;
export declare function calculateVisibleColumns(scrollLeft: number, containerWidth: number, columns: UiTableColumn[], options?: {
    zoom?: number;
