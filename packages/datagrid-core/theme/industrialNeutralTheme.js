 ...
 */
export const industrialNeutralTheme = {
    inheritThemeFromDocument: true,
    defaultTokenVariant: "light",
    tokenVariants: {
        light: {
            tableFontFamily: '"IBM Plex Mono", ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace',
