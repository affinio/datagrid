  ...
  if (themePreset.value === "custom") {
    return {
      ...
      tokens: {
        ...
        gridFilterPanelBorderColor: "rgba(234, 88, 12, 0.26)",
        gridFilterPanelBackground: "#fff8f3",
        gridFilterIndicatorActiveColor: "#ea580c",
        gridMetricsCardBackground: "rgba(255, 237, 213, 0.72)",
        gridFocusOutlineColor: "rgba(234, 88, 12, 0.62)",
        gridHeaderRowBackgroundColor: "#fed7aa",
        gridHeaderCellBackgroundColor: "#fdba74",
        gridHeaderCellHoverBackgroundColor: "#fb923c",
        gridHeaderFilterOpenBackgroundColor: "#fed7aa",
        headerBackgroundColor: "#fdba74",
        headerTextColor: "#5f1d0f",
        headerBorderColor: "rgba(194, 65, 12, 0.26)",
        headerHighlightBorderColor: "rgba(234, 88, 12, 0.72)",
        headerHighlightTextColor: "#9a3412",
        ...
        bodyCellPaddingX: "0.78rem",
        bodyCellPaddingY: "0.34rem",
        selectionCellBackgroundColor: "#fed7aa",
        ...
        pinnedLeftBorderColor: "rgba(194, 65, 12, 0.24)",
        pinnedLeftBorderWidth: "1px",
        pinnedRightBorderColor: "rgba(194, 65, 12, 0.24)",
        pinnedRightBorderWidth: "1px",
        gridHeroBackgroundStart: "#fff2e8",
        gridHeroBackgroundEnd: "#ffedd5",
        gridChipBackground: "rgba(254, 215, 170, 0.68)",
        ...
        gridResizeHandleHoverColor: "#ea580c",
        gridSelectionRangeBackgroundColor: "rgba(249, 115, 22, 0.16)",
        gridSelectionCopiedBorderColor: "rgba(194, 65, 12, 0.68)",
        gridSelectionCopiedBackgroundColor: "rgba(249, 115, 22, 0.1)",
        ...
        gridSortPriorityBorderColor: "rgba(194, 65, 12, 0.36)",
        gridHeaderFilterHighlightColor: "rgba(234, 88, 12, 0.56)",
        gridCheckboxAccentColor: "#ea580c",
        gridNumericTextColor: "#9a3412",
        gridEditableHoverBackgroundColor: "#fff0e3",
        gridEnumTriggerBorderColor: "rgba(234, 88, 12, 0.3)",
        gridEnumTriggerBackgroundColor: "#fff8f3",
        gridEnumTriggerTextColor: "#9a3412",
        gridEnumTriggerHoverBorderColor: "rgba(194, 65, 12, 0.54)",
        gridEnumTriggerHoverBackgroundColor: "#ffedd5",
        gridStickyBackgroundColor: "#fff1e6",
        gridStickyShadowColor: "rgba(124, 45, 18, 0.14)",
        gridStickyRangeBackgroundColor: "rgba(249, 115, 22, 0.18)",
        gridStickyRangeBorderColor: "rgba(194, 65, 12, 0.44)",
        gridStickyAnchorBackgroundColor: "rgba(249, 115, 22, 0.22)",
        gridStickyAnchorBorderColor: "#ea580c",
        gridStickyActiveBorderColor: "#c2410c",
        gridHeaderStickyBackgroundColor: "#fed7aa",
        gridRowSelectedStickyBackgroundColor: "#fed7aa",
        gridRowSelectedRangeBackgroundColor: "rgba(249, 115, 22, 0.18)",
        gridGroupStartGradientStart: "rgba(249, 115, 22, 0.14)",
        gridGroupStartGradientEnd: "#ffedd5",
        gridGroupBadgeTextColor: "#9a3412",
        gridSelectionOverlayBorderColor: "rgba(234, 88, 12, 0.78)",
        gridSelectionOverlayBackgroundColor: "rgba(249, 115, 22, 0.08)",
        gridSelectionOverlayFillBorderColor: "rgba(194, 65, 12, 0.7)",
        gridSelectionOverlayFillBackgroundColor: "rgba(249, 115, 22, 0.1)",
        gridSelectionOverlayMoveBorderColor: "rgba(154, 52, 18, 0.72)",
        gridSelectionOverlayMoveBackgroundColor: "rgba(234, 88, 12, 0.1)",
        gridMoveHandleHoverBackgroundColor: "rgba(249, 115, 22, 0.16)",
        gridHintBorderColor: "rgba(194, 65, 12, 0.2)",
        gridHintBackgroundColor: "#fff8f3",
        gridCopyMenuBorderColor: "rgba(194, 65, 12, 0.24)",
        gridCopyMenuBackgroundColor: "#fff8f3",
        gridCopyMenuShadowColor: "rgba(124, 45, 18, 0.14)",
        gridCopyMenuItemHoverBorderColor: "rgba(194, 65, 12, 0.24)",
        gridCopyMenuItemHoverBackgroundColor: "#ffedd5",
