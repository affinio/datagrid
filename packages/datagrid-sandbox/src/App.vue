<template>
  <main class="sandbox">
    <header class="sandbox__header">
      ...
      <p>Functional sandbox for manual validation and future E2E scenarios.</p>
    </header>
    ...
    <nav class="sandbox__nav">
      ...
      <RouterLink class="sandbox__link" to="/vue/shell/gantt-grid">Vue Gantt Showcase</RouterLink>
      <RouterLink class="sandbox__link" to="/vue/shell/timesheet-grid">Vue Timesheet Showcase</RouterLink>
