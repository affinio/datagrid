...
export function useDataGridTableStageBindings<TRow extends Record<string, unknown>>(
  ...
  const viewportSection = computed<DataGridTableStageViewportSection>(() => ({
    ...
    viewportRowEnd: unref(options.viewportRowEnd),
    virtualRowTotal: unref(options.virtualRowTotal),
    baseRowHeight: unref(options.baseRowHeight),
    resolveRowHeight: unref(options.resolveRowHeight),
    resolveRowOffset: unref(options.resolveRowOffset),
  ...
  const rowsSection = computed<DataGridTableStageRowsSection<TRow>>(() => ({
    ...
    reorderRowsByIndex: unref(options.reorderRowsByIndex),
