...
export function useDataGridResizeClickGuard(
  options: UseDataGridResizeClickGuardOptions = {},
): UseDataGridResizeClickGuardResult {
  ...
  let delayedReleaseTimer: ReturnType<typeof setTimeout> | null = null
  ...
  function clearDelayedReleaseTimer(): void {
  ...
  function detachReleaseListeners(): void {
  ...
  function releaseResizeGuard(): void {
    resizeActive = false
  ...
  function shouldBlockClick(): boolean {
    if (resizeActive) {
      return true
    }
