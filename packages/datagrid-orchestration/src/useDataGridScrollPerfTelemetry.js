...
export function useDataGridScrollPerfTelemetry(options = {}) {
    ...
    function computeQuality(nextFrameCount, nextFps, nextDroppedFrames, nextLongTaskFrames) {
