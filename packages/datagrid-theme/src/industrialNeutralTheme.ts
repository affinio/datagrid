...
export const industrialNeutralTheme: DataGridStyleConfig = {
  ...
  tokenVariants: {
    light: {
      ...
      headerHighlightBorderColor: toRgba(palette.blue500, 0.72),
      headerHighlightTextColor: toRgb(palette.blue600),
      headerSelectedTextColor: toRgb(palette.slate800),
      headerSystemTextColor: toRgb(palette.slate600),
    ...
    dark: {
      ...
      headerPaddingX: "0.75rem",
      headerPaddingY: "0.5rem",
      headerHighlightBorderColor: toRgba(palette.blue300, 0.75),
      headerHighlightTextColor: toRgba(palette.blue200, 0.95),
      headerSelectedTextColor: toRgb(palette.gray50),
      headerSystemTextColor: toRgba(palette.gray300, 0.84),
