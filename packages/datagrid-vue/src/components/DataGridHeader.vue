...
import { DataGridHeaderContextKey, type DataGridRowRegion } from "../context"
...
const header = inject(DataGridHeaderContextKey)
if (!header) {
  throw new Error("DataGridHeader requires DataGridHeaderContext")
}
...
const rowRegion = computed<DataGridRowRegion>(() => {
