...
const PERF_BUDGET_MAX_REFRESH_AWARE_DROPPED_FRAME_PCT = floatEnv(
  "PERF_BUDGET_MAX_REFRESH_AWARE_DROPPED_FRAME_PCT",
  999999,
)
...
for (const [value, label] of [
  ...
  [PERF_BUDGET_MAX_REFRESH_AWARE_DROPPED_FRAME_PCT, "PERF_BUDGET_MAX_REFRESH_AWARE_DROPPED_FRAME_PCT"],
...
function buildBrowserResourceBudgetWarnings(aggregate) {
  ...
  addWarningIfAbove(
    warnings,
    `enterprise browser refresh-aware dropped frame pct p95 @ ${BENCH_BROWSER_REFRESH_RATE_HZ}Hz`,
    aggregate.refreshAwareDroppedFramePct.p95,
    PERF_BUDGET_MAX_REFRESH_AWARE_DROPPED_FRAME_PCT,
  )
...
const summary = {
  ...
  config: {
    ...
    resourceBudgets: {
      ...
      refreshAwareDroppedFramePct: PERF_BUDGET_MAX_REFRESH_AWARE_DROPPED_FRAME_PCT,
  ...
  budgets: {
    ...
    maxRefreshAwareDroppedFramePct: PERF_BUDGET_MAX_REFRESH_AWARE_DROPPED_FRAME_PCT,
