...
const tasks = [
  ...
  },
  {
    ...
    budgets: {
      ...
      local: {
        ...
        PERF_BUDGET_MAX_PLACEHOLDER_EXPOSURE_MAX_MS: "Infinity",
        PERF_BUDGET_MAX_VIEWPORT_DATA_AVAILABILITY_MAX_MS: "Infinity",
        PERF_BUDGET_MIN_PLACEHOLDER_EXPOSURE_EVENTS: "0",
        PERF_BUDGET_PLACEHOLDER_FAIL_ON_WARNINGS: "false",
      },
    },
  },
  ...
  },
  {
    id: "pivot-workload",
    command: "node",
    args: ["--expose-gc", "./scripts/bench-datagrid-pivot-workload.mjs"],
    retries: 1,
    jsonPath: `${outputDir}/bench-datagrid-pivot-workload.json`,
    logPath: `${outputDir}/bench-datagrid-pivot-workload.log`,
    budgets: {
      ci: {
        BENCH_PIVOT_ROW_COUNT: "16000",
        BENCH_PIVOT_REBUILD_ITERATIONS: "72",
        BENCH_PIVOT_PATCH_FROZEN_ITERATIONS: "96",
        BENCH_PIVOT_PATCH_REAPPLY_ITERATIONS: "56",
        BENCH_PIVOT_PATCH_ROWS_PER_ITERATION: "3",
      ...
      local: {
        PERF_BUDGET_TOTAL_MS: "Infinity",
        PERF_BUDGET_MAX_PIVOT_REBUILD_P95_MS: "Infinity",
        PERF_BUDGET_MAX_PIVOT_REBUILD_P99_MS: "Infinity",
        PERF_BUDGET_MAX_PIVOT_PATCH_FROZEN_P95_MS: "Infinity",
        PERF_BUDGET_MAX_PIVOT_PATCH_FROZEN_P99_MS: "Infinity",
        PERF_BUDGET_MAX_PIVOT_PATCH_REAPPLY_P95_MS: "Infinity",
        PERF_BUDGET_MAX_PIVOT_PATCH_REAPPLY_P99_MS: "Infinity",
        PERF_BUDGET_MIN_PIVOT_COLUMNS: "0",
      },
    },
  },
  {
  ...
  },
  {
    ...
    command: "node",
    args: ["./scripts/bench-datagrid-enterprise-browser-frames.mjs"],
    retries: 1,
    jsonPath: `${outputDir}/bench-datagrid-enterprise-browser-frames.json`,
    logPath: `${outputDir}/bench-datagrid-enterprise-browser-frames.log`,
    budgets: {
      ci: {
        BENCH_BROWSER_SCENARIOS: "vertical-scroll-only,vertical-smooth-scroll,horizontal-scroll-only,wide-table-1k-pinned-horizontal,wide-table-10k-pinned-horizontal,server-datasource-placeholder-scroll,rendering-plain-100k,rendering-slow-custom-renderers,rendering-wide-pinned-horizontal,rendering-auto-height-custom-renderers,rendering-overlay-heavy-selection-fill",
        BENCH_BROWSER_SESSIONS: "1",
        BENCH_BROWSER_ROW_COUNT: "100000",
        BENCH_BROWSER_WIDE_ROW_COUNT: "10000",
        BENCH_BROWSER_WIDE_ROW_SCENARIOS: "horizontal-scroll-only,wide-table-1k-pinned-horizontal,wide-table-10k-pinned-horizontal,rendering-wide-pinned-horizontal",
        BENCH_BROWSER_COLUMN_COUNT: "32",
        BENCH_BROWSER_WIDE_COLUMN_COUNT: "1000",
        BENCH_BROWSER_WIDE_COLUMN_SCENARIOS: "horizontal-scroll-only,wide-table-1k-pinned-horizontal,wide-table-10k-pinned-horizontal,rendering-wide-pinned-horizontal",
        BENCH_BROWSER_SCROLL_STEPS: "120",
        BENCH_BROWSER_SMOOTH_SCROLL_STEPS: "360",
        BENCH_BROWSER_HORIZONTAL_STEPS: "64",
        BENCH_BROWSER_STEP_DELAY_MS: "8",
        BENCH_BROWSER_REFRESH_RATE_HZ: "60",
        BENCH_INTERACTION_FAIL_ON_WARNINGS: "true",
        BENCH_BROWSER_RESOURCE_FAIL_ON_WARNINGS: "true",
        BENCH_VIRTUALIZATION_FAIL_ON_WARNINGS: "true",
        BENCH_RENDERING_FAIL_ON_WARNINGS: "true",
        PERF_BUDGET_TOTAL_MS: "180000",
        PERF_BUDGET_MAX_VARIANCE_PCT: "180",
        PERF_BUDGET_MAX_HEAP_DELTA_MB: "260",
        PERF_BUDGET_MAX_FRAME_P95_MS: "180",
        PERF_BUDGET_MAX_DROPPED_FRAME_PCT: "100",
        PERF_BUDGET_MAX_REFRESH_AWARE_DROPPED_FRAME_PCT: "100",
        PERF_BUDGET_MAX_LONG_TASK_COUNT: "600",
        PERF_BUDGET_MAX_VIRTUALIZATION_VIEWPORT_UPDATE_P95_MS: "180",
        PERF_BUDGET_MAX_VIRTUALIZATION_RANGE_RESOLVE_P95_MS: "10",
        PERF_BUDGET_MAX_VIRTUALIZATION_RENDERED_ROWS_P95: "180",
        PERF_BUDGET_MAX_VIRTUALIZATION_RENDERED_COLUMNS_P95: "160",
        PERF_BUDGET_MAX_VIRTUALIZATION_BLANK_VIEWPORTS: "0",
        PERF_BUDGET_MAX_VIRTUALIZATION_PLACEHOLDER_ROWS: "220",
        PERF_BUDGET_MAX_RENDER_ROW_MOUNTS_PER_SCROLL_WRITE: "220",
        PERF_BUDGET_MAX_RENDER_ROW_UNMOUNTS_PER_SCROLL_WRITE: "220",
        PERF_BUDGET_MAX_RENDER_CELL_MOUNTS_PER_SCROLL_WRITE: "30000",
        PERF_BUDGET_MAX_RENDER_CELL_UNMOUNTS_PER_SCROLL_WRITE: "30000",
        PERF_BUDGET_MAX_CELL_RENDERER_P95_MS: "8",
        PERF_BUDGET_MAX_GROUP_CELL_RENDERER_P95_MS: "8",
      },
      local: {
        BENCH_BROWSER_SCENARIOS: "vertical-scroll-only,horizontal-scroll-only,wide-table-1k-pinned-horizontal,server-datasource-placeholder-scroll,rendering-plain-100k,rendering-slow-custom-renderers,rendering-wide-pinned-horizontal,rendering-auto-height-custom-renderers,rendering-overlay-heavy-selection-fill",
        BENCH_BROWSER_SESSIONS: "1",
        BENCH_BROWSER_ROW_COUNT: "100000",
        BENCH_BROWSER_WIDE_ROW_COUNT: "10000",
        BENCH_BROWSER_WIDE_ROW_SCENARIOS: "horizontal-scroll-only,wide-table-1k-pinned-horizontal,rendering-wide-pinned-horizontal",
        BENCH_BROWSER_COLUMN_COUNT: "32",
        BENCH_BROWSER_WIDE_COLUMN_COUNT: "1000",
        BENCH_BROWSER_WIDE_COLUMN_SCENARIOS: "horizontal-scroll-only,wide-table-1k-pinned-horizontal,rendering-wide-pinned-horizontal",
        BENCH_BROWSER_SCROLL_STEPS: "80",
        BENCH_BROWSER_SMOOTH_SCROLL_STEPS: "240",
        BENCH_BROWSER_HORIZONTAL_STEPS: "48",
        BENCH_INTERACTION_FAIL_ON_WARNINGS: "false",
        BENCH_VIRTUALIZATION_FAIL_ON_WARNINGS: "false",
        BENCH_RENDERING_FAIL_ON_WARNINGS: "false",
        PERF_BUDGET_TOTAL_MS: "300000",
        PERF_BUDGET_MAX_VARIANCE_PCT: "999999",
        PERF_BUDGET_MAX_HEAP_DELTA_MB: "999999",
        PERF_BUDGET_MAX_FRAME_P95_MS: "999999",
        PERF_BUDGET_MAX_DROPPED_FRAME_PCT: "999999",
        PERF_BUDGET_MAX_LONG_TASK_COUNT: "999999",
        PERF_BUDGET_MAX_VIRTUALIZATION_VIEWPORT_UPDATE_P95_MS: "999999",
        PERF_BUDGET_MAX_VIRTUALIZATION_RANGE_RESOLVE_P95_MS: "999999",
        PERF_BUDGET_MAX_VIRTUALIZATION_RENDERED_ROWS_P95: "999999",
        PERF_BUDGET_MAX_VIRTUALIZATION_RENDERED_COLUMNS_P95: "999999",
        PERF_BUDGET_MAX_VIRTUALIZATION_BLANK_VIEWPORTS: "999999",
        PERF_BUDGET_MAX_VIRTUALIZATION_PLACEHOLDER_ROWS: "999999",
        PERF_BUDGET_MAX_RENDER_ROW_MOUNTS_PER_SCROLL_WRITE: "999999",
        PERF_BUDGET_MAX_RENDER_ROW_UNMOUNTS_PER_SCROLL_WRITE: "999999",
        PERF_BUDGET_MAX_RENDER_CELL_MOUNTS_PER_SCROLL_WRITE: "999999",
        PERF_BUDGET_MAX_RENDER_CELL_UNMOUNTS_PER_SCROLL_WRITE: "999999",
        PERF_BUDGET_MAX_CELL_RENDERER_P95_MS: "999999",
        PERF_BUDGET_MAX_GROUP_CELL_RENDERER_P95_MS: "999999",
      },
    },
  },
  {
