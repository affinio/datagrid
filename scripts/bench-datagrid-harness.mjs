...
const tasks = [
  ...
  },
  {
    ...
    budgets: {
      ci: {
        BENCH_BROWSER_SCENARIOS: "vertical-scroll-only,vertical-smooth-scroll,horizontal-scroll-only,server-datasource-placeholder-scroll,rendering-plain-100k,rendering-slow-custom-renderers,rendering-wide-pinned-horizontal,rendering-auto-height-custom-renderers,rendering-overlay-heavy-selection-fill",
        BENCH_BROWSER_SESSIONS: "1",
        BENCH_BROWSER_ROW_COUNT: "100000",
        BENCH_BROWSER_WIDE_ROW_COUNT: "10000",
        BENCH_BROWSER_WIDE_ROW_SCENARIOS: "horizontal-scroll-only,rendering-wide-pinned-horizontal",
        BENCH_BROWSER_COLUMN_COUNT: "32",
        BENCH_BROWSER_WIDE_COLUMN_COUNT: "1000",
        BENCH_BROWSER_WIDE_COLUMN_SCENARIOS: "horizontal-scroll-only,rendering-wide-pinned-horizontal",
        ...
        PERF_BUDGET_MAX_FRAME_P95_MS: "120",
        PERF_BUDGET_MAX_DROPPED_FRAME_PCT: "90",
      ...
      local: {
        BENCH_BROWSER_SCENARIOS: "vertical-scroll-only,horizontal-scroll-only,server-datasource-placeholder-scroll,rendering-plain-100k,rendering-slow-custom-renderers,rendering-wide-pinned-horizontal,rendering-auto-height-custom-renderers,rendering-overlay-heavy-selection-fill",
        BENCH_BROWSER_SESSIONS: "1",
        BENCH_BROWSER_ROW_COUNT: "100000",
        BENCH_BROWSER_WIDE_ROW_COUNT: "10000",
        BENCH_BROWSER_WIDE_ROW_SCENARIOS: "horizontal-scroll-only,rendering-wide-pinned-horizontal",
