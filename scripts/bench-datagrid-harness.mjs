...
const tasks = [
  ...
  },
  {
    ...
    budgets: {
      ci: {
        BENCH_BROWSER_SCENARIOS: "vertical-scroll-only,vertical-smooth-scroll,horizontal-scroll-only,server-datasource-placeholder-scroll",
        BENCH_BROWSER_SESSIONS: "1",
        BENCH_BROWSER_ROW_COUNT: "100000",
        BENCH_BROWSER_WIDE_ROW_COUNT: "10000",
        BENCH_BROWSER_WIDE_ROW_SCENARIOS: "horizontal-scroll-only",
        BENCH_BROWSER_COLUMN_COUNT: "32",
        BENCH_BROWSER_WIDE_COLUMN_COUNT: "1000",
        BENCH_BROWSER_WIDE_COLUMN_SCENARIOS: "horizontal-scroll-only",
      ...
      local: {
        BENCH_BROWSER_SCENARIOS: "vertical-scroll-only,horizontal-scroll-only,server-datasource-placeholder-scroll",
        BENCH_BROWSER_SESSIONS: "1",
        BENCH_BROWSER_ROW_COUNT: "100000",
        BENCH_BROWSER_WIDE_ROW_COUNT: "10000",
        BENCH_BROWSER_WIDE_ROW_SCENARIOS: "horizontal-scroll-only",
